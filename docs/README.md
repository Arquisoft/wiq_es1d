...
The deployment url is: [https://arquisoft.github.io/wiq_es1d/](https://arquisoft.github.io/wiq_es1d/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es1d/](https://arquisoft.github.io/wiq_es1d/), we need to execute `npm run deploy`.
